...
cities_of_russia = [
    ...
    "Киров", "Липецк", "Чебоксары", "Брянск", "Тула", "Калининград", 
    "Курск", "Ставрополь", "Магнитогорск", "Тверь", "Сочи", 
    "Иваново", "Белгород", "Сургут", "Владимир", "Архангельск", 
    "Набережные Челны", "Калуга", "Смоленск", "Волжский", "Череповец", 
    "Чита", "Орёл", "Владикавказ", "Мурманск", "Тамбов", "Петрозаводск", 
    "Нижний Тагил", "Курган", "Стерлитамак", "Грозный", "Комсомольск-на-Амуре", 
    "Кострома", "Якутск", "Каменск-Уральский", "Шахты", "Сызрань", 
    "Новороссийск", "Балашиха", "Химки", "Энгельс", "Королёв", "Подольск"
]
...
for i in range(records_num):
    ...
    address = {
        "region": fake.region(),
        "city": r.choice(cities_of_russia),
